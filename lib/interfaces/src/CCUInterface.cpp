...
void CCUInterface::handle_enqueue_acu_cell_voltages_CAN_message(
    ...
    size_t num_of_groups = voltage_cells_per_chip[_curr_data.current_voltage_group_chip_id] / _ccu_params.voltage_cells_per_group;
    size_t num_of_voltage_cells = std::accumulate(voltage_cells_per_chip, voltage_cells_per_chip + num_of_chips, 0);
    ...
    bool voltage_cell_group_cycle_loop_completed = _increment_and_loop_id(_curr_data.current_voltage_cell_group_id, num_of_groups);
...
void CCUInterface::handle_enqueue_acu_cell_temps_CAN_message(
    ...
    size_t num_of_groups = temp_cells_per_chip[_curr_data.current_temp_group_chip_id] / _ccu_params.temp_cells_per_group;
    size_t num_of_temp_cells = std::accumulate(temp_cells_per_chip, temp_cells_per_chip + num_of_chips, 0);
