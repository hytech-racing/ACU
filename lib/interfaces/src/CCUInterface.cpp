...
void CCUInterface::handle_enqueue_acu_temps_CAN_message()
{
    ...
    CAN_util::enqueue_msg(&temp_msg, &Pack_BMS_TEMPS_hytech, ACUCANInterfaceImpl::ccu_can_tx_buffer);
    ...
    CAN_util::enqueue_msg(&detailed_board_temp_msg, &Pack_BMS_BOARD_DETAILED_TEMPS_hytech, ACUCANInterfaceImpl::ccu_can_tx_buffer);
} 
