...
namespace acu_controller_default_params
{
    ...
    constexpr const time_ms MAX_VOLTAGE_FAULT_DUR = 2000; // At 15 Hz, we'll know if there is an error within 3 seconds of startup
    constexpr const time_ms MAX_TEMP_FAULT_DUR = 1000; // Same as voltage fault count
