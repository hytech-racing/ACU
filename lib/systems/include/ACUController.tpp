...
{
    bool ov_fault = (current_millis - _acu_state.ov_start_time) > _parameters.max_allowed_voltage_fault_dur;
    bool uv_fault = (current_millis - _acu_state.uv_start_time) > _parameters.max_allowed_voltage_fault_dur;
    bool pack_fault = (current_millis - _acu_state.pack_uv_start_time) > _parameters.max_allowed_voltage_fault_dur;
...
{
    bool cell_ot_fault = (current_millis - _acu_state.cell_ot_start_time) > _parameters.max_allowed_temp_fault_dur;
    bool board_ot_fault = (current_millis - _acu_state.board_ot_start_time) > _parameters.max_allowed_temp_fault_dur;
