...
{  
    ...
    constexpr uint32_t KICK_WATCHDOG_PERIOD_US = 5000UL; // 10 000 us = 100 Hz
    constexpr uint32_t WATCHDOG_PRIORITY = 1;
    constexpr uint32_t SAMPLE_BMS_PERIOD_US = 4000UL; // 5 000 us = 200 Hz (since we are reading by group)
