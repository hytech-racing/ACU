...
{  
    ...
    constexpr std::array<size_t, NUM_CHIPS> TEMP_CELLS_PER_CHIP = {
        4, 4, 4, 4, 4, 4,
        4, 4, 4, 4, 4, 4
    };
    constexpr std::array<size_t, NUM_CHIPS> VOLTAGE_CELLS_PER_CHIP = {
        12, 9, 12, 9, 12, 9,
        12, 9, 12, 9, 12, 9
    };
