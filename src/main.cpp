...
::HT_TASK::Task sample_em_temp_sensor_task(HT_TASK::DUMMY_FUNCTION, sample_em_temp_sensor, ACUConstants::EM_TEMP_SENSOR_PRIORITY, ACUConstants::EM_TEMP_SENSOR_PERIOD_US);
...
void setup()
{
    ...
    scheduler.schedule(sample_em_temp_sensor_task);
